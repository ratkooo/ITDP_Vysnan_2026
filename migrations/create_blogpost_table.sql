CREATE TABLE IF NOT EXISTS blog_posts (
    ...
    author VARCHAR(100) DEFAULT 'Software Engineer',
...
SELECT
    'Embracing Decoupled Architecture in Modern PHP',
    'An architectural look at separating backend routing frameworks from client-side visual templates.',
    'Building applications using modern patterns requires clear boundary separation. By isolating database operations from frontend controllers, engineers gain system predictability, easier automated testing loops, and optimal deployment metrics inside container ecosystems like Docker.'
